...
![Modelling Data](../image/4_modelling_data.png){#fig-modelling-structure width="80%" fig-align="center"}
...
A key challenge in our [modelling process](#fig-modelling-structure) is integrating multiple datasets that use inconsistent or non-standard identifiers for restaurants and menu items.\
