...
# It processes DataFrames containing menu data and returns cleaned JSON output for downstream analytics.
# To use it, call `run_qc_extraction(df_input=your_dataframe)`.
# The output is a list of dictionaries with the following fields:
