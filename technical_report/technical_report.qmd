...
- **Popularity-Based Recommendation:** Popularity is a widely accepted baseline metric in the industry, used by platforms like Yelp, Spotify, and GitHub. For instance, GitHub calculates a popularity score based on the number of forks a repository receives.
...
We provided detailed user instructions on how to set up the environment and execute the code in the **[README file of the repository](https://github.com/UBC-MDS/heymate-report)**. There are a few areas where this project could be extended:
